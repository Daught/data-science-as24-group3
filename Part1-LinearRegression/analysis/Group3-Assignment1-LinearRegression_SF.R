...
#LC_Cleaned <- subset(LC_Cleaned, select = -term)
...
if(!require('randomForest')) {      # For bagging and random forests
...
# We can read it off the model output:
tree.rf
...
# Optimizing ntree:
plot(tree.rf)
# We see again that the OOB error stabilizes after 500 trees. No need to use to change ntree
